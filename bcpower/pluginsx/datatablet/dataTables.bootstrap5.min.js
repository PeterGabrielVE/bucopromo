...
!function(t) {
  ...
  'function' == typeof define && define.amd
      ...
      : 'object' == typeof exports ? (n = require('jquery'), r = function(
          e, a) {a.fn.dataTable || require('datatables.net')(e, a);}, 'undefined' ==
      typeof window ? module.exports = function(e, a) {
        return e = e || window, a = a || n(e), r(e, a), t(a, 0, e.document);
      } : (r(window, n), module.exports = t(n, window, window.document))) : t(
  ...
  return x.extend(!0, i.defaults, {
    ...
    function u(e, a) {
      for (var t, n, r = function(e) {
        ...
        b.page() == e.data.action || b.page(e.data.action).draw('page');
      }, o = 0, i = a.length; o < i; o++) if (t = a[o], Array.isArray(t)) u(e,
          t); else {
        switch (f = p = '', t) {
          case'ellipsis':
            p = '&#x2026;', f = 'disabled';
        ...
        p && (n = -1 !== f.indexOf('disabled'), n = x('<li>', {
          ...
          id: 0 === s && 'string' == typeof t ? d.sTableId + '_' + t : null,
            ...
            appendTo(e), d.oApi._fnBindAction(n, {action: t}, r));
      }
    }

    var p, f, t, b = new i.Api(d), m = d.oClasses, g = d.oLanguage.oPaginate,
        w = d.oLanguage.oAria.paginate || {}, e = x(e);
    try {t = e.find(r.activeElement).data('dt-idx');} catch (e) {}
    var n = e.children('ul.pagination');
    n.length ? n.empty() : n = e.html('<ul/>').
        children('ul').
        addClass('pagination'), u(n, a), t !== o &&
    e.find('[data-dt-idx=' + t + ']').trigger('focus');
  }, i;
});
