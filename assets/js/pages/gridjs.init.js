document.getElementById('table-gridjs') && new gridjs.Grid({
  columns: [
    ...
    {name: 'Name', width: '150px'},
    {
      name: 'Email',
      width: '220px',
      formatter: function(e) {return gridjs.html('<a href="">' + e + '</a>');},
    },
  ...
  data: [
    ...
    [
      ...
      'Qatar']],
}).render(document.getElementById('table-gridjs')), document.getElementById(
    'table-card') && new gridjs.Grid({
  columns: [
    {name: 'Name', width: '150px'},
  ...
  data: [
    ...
    [
      ...
      'Raynor, Rolfson and Daugherty',
      'Qatar']],
}).render(document.getElementById('table-card')), document.getElementById(
    'table-pagination') && new gridjs.Grid({
  columns: [
    {
      name: 'ID',
      width: '120px',
...
}).render(document.getElementById('table-pagination')), document.getElementById(
    'table-search') && new gridjs.Grid({
  columns: [
    {name: 'Name', width: '150px'},
    {name: 'Email', width: '250px'},
    {name: 'Position', width: '250px'},
  ...
  data: [
    ...
    [
      ...
      'Raynor, Rolfson and Daugherty',
      'Qatar']],
}).render(document.getElementById('table-search')), document.getElementById(
    'table-sorting') && new gridjs.Grid({
  columns: [
    {name: 'Name', width: '150px'},
    {name: 'Email', width: '250px'},
    {name: 'Position', width: '250px'},
  ...
  data: [
    ...
    [
      ...
      'Raynor, Rolfson and Daugherty',
      'Qatar']],
}).render(document.getElementById('table-sorting')), document.getElementById(
    'table-loading-state') && new gridjs.Grid({
  columns: [
    {name: 'Name', width: '150px'},
    {name: 'Email', width: '250px'},
    {name: 'Position', width: '250px'},
  ...
  data: function() {
    ...
    document.getElementById('table-loading-state')), document.getElementById(
    'table-fixed-header') && new gridjs.Grid({
  columns: [
    {name: 'Name', width: '150px'},
    {name: 'Email', width: '250px'},
    {name: 'Position', width: '250px'},
  ...
  data: [
    ...
    document.getElementById('table-fixed-header')), document.getElementById(
    'table-hidden-column') && new gridjs.Grid({
  columns: [
