  ...
  if (null !== document.getElementById(e)) {
    ...
    if (t) return (t = JSON.parse(t)).map(function(e) {
      ...
      return -1 === t.indexOf(',') ? getComputedStyle(document.documentElement).
          getPropertyValue(t) || t : 2 == (e = e.split(',')).length ? 'rgba(' +
...
var options, chart,
    ...
    isApexSeriesData = (linechartcustomerColors && (options = {
      ...
      xaxis: {
        categories: [
          ...
          'Oct',
          'Nov',
          'Dec'], axisTicks: {show: !1}, axisBorder: {show: !1},
      },
      grid: {
        show: !0,
        xaxis: {lines: {show: !0}},
    ...
    donutchartProjectsStatusColors = (isApexSeries &&
    Array.from(isApexSeries).forEach(function(e) {
      var t, e = e.attributes;
      e['data-chart-series'] &&
      (isApexSeriesData.series = e['data-chart-series'].value.toString(), t = getChartColorsArray(
          e.id.value.toString()), t = {
        ...
        colors: t,
      }, new ApexCharts(document.querySelector('#' + e.id.value.toString()),
          t).render());
    ...
    }, (chart = new ApexCharts(document.querySelector('#prjects-status'),
        options)).render()), 'users-chat');

function scrollToBottom(e) {
  setTimeout(() => {
    new SimpleBar(document.getElementById(
        'chat-conversation')).getScrollElement().scrollTop = document.getElementById(
        'users-conversation').scrollHeight;
  }, 100);
}
